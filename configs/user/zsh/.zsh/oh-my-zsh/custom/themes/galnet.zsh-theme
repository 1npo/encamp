...
setopt prompt_subst
PROMPT="${lightslateblue}%m%{$reset_color%} in ${midgray}%~%{$reset_color%}\$(virtualenv_prompt_info)\$(ruby_prompt_info)\$vcs_info_msg_0_${darkgray} %%%{$reset_color%} "
